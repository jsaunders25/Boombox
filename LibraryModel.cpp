...
bool LibraryModel::insertColumns(int column, int count, const QModelIndex &parent)
{
...
bool LibraryModel::removeColumns(int column, int count, const QModelIndex &parent)
{
